        ...
        if total_count > 0:
            if unit_count > 0:
                ...
                if total_count < unit_count:
                    ...
                    note = (
                        f"Browse PROCESS total ({total_count}) is lower than validated UNIT_PROCESS count "
                        f"({unit_count}). LCI_RESULT set to 0; counts need review."
                    )
                else:
                    status = "available"
                    note = (
                ...
                note = (
                    ...
                    "UNIT_PROCESS count was available. LCI_RESULT split cannot be derived."
                )
        else:
